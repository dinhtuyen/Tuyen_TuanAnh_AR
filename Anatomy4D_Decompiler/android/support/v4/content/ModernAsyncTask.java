...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00121 implements ThreadFactory {
    ...
    class C00132 extends WorkerRunnable<Params, Result> {
        C00132() {
            super();
        }
    ...
    class C00143 extends FutureTask<Result> {
        C00143(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00132();
        this.mFuture = new C00143(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00154.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
