...
class AccessibilityManagerCompatIcs {
    ...
    static class C00391 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C00391(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
