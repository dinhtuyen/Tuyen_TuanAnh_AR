...
class SearchViewCompatHoneycomb {
    ...
    static class C00481 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00481(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00492 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00492(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
