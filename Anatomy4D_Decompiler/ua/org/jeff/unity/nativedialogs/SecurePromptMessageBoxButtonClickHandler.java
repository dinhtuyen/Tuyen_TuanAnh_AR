...
public class SecurePromptMessageBoxButtonClickHandler implements OnClickListener {
    String _button;
    String _callbackObject;
    EditText _editText;
    int _id;

    SecurePromptMessageBoxButtonClickHandler(String button, String callbackObject, EditText editText, int id) {
        this._button = button;
